...
TOKEN = "MTA3NjUxMjg2MjU2ODE4NTkyNw.GoHhWx.dza_G2qP-QUAuzUfpe_w7Q8NAiEdY5o9W_fKzY"
gif = ""
adet = 25
saniye = 0
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="Kartopu atmayı severim.")
